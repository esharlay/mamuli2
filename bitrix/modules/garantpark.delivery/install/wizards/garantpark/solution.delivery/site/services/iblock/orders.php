...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/orders/add.php", array("ORDERS_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("ORDERS_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."orders/", Array("ORDERS_ID" => $iblockID));
?>
