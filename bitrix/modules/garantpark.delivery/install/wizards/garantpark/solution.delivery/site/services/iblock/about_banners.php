...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/about_banners.xml";
$iblockCode = "about_banners_" . WIZARD_SITE_ID;
$iblockType = "elements";
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("ABOUT_BANNERS_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("BANNERS_ON_ABOUT_ID" => $iblockID));
?>
