...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/promodiscounts.xml";
$iblockCode = "promodiscounts_" . WIZARD_SITE_ID;
$iblockType = "elements";
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("PROMODISCOUNTS_ID" => $iblockID));
?>
