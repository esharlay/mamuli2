...
$iblockCode = "objects_" . WIZARD_SITE_ID;
$iblockType = "objects";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/orders/detail.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/orders/index.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/orders/add.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/cart.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/main_menu.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/index.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/detail.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/section.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/new.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/recommends.php", array("OBJECTS_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/menu/hits.php", array("OBJECTS_ID" => $iblockID));
?>
