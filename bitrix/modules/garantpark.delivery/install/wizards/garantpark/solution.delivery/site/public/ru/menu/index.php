...
<?
	...
	if ($section_id){
		...
		$ar_result = CIBlockSection::GetList(Array("SORT"=>"­­ASC"), Array("IBLOCK_ID"=>"#OBJECTS_ID#","ID"=>$section_id, "DEPTH_LEVEL" => "1"),
			false, Array("ID","NAME"));
		if ($ar_result){
		...
		$ar_result = CIBlockSection::GetList(Array("SORT"=>"­­ASC"), Array("IBLOCK_ID"=>"#OBJECTS_ID#","SECTION_ID"=>$section_id, "DEPTH_LEVEL" => "2"),
