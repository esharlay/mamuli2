...
*/
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."objects/", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
elseif(!file_exists(WIZARD_SITE_PATH."include_areas/company_name.php"))
{
	...
	___writeToAreasFile(WIZARD_SITE_PATH."include/company_name.php", '<h1>Стройдом</h1><h2>Строительная компания</h2>');
}
