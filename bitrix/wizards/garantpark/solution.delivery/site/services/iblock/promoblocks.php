...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/promoblocks.xml";
$iblockCode = "promoblocks_" . WIZARD_SITE_ID;
$iblockType = "elements";
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("PROMOBLOCKS_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."stocks/", Array("PROMOBLOCKS_ID" => $iblockID));
