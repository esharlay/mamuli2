...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/about_discounts.xml";
$iblockCode = "about_discounts_" . WIZARD_SITE_ID;
$iblockType = "elements";
...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("ABOUT_DISCOUNTS_ID" => $iblockID));
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."include/", Array("DISCOUNTS_ON_ABOUT_ID" => $iblockID));
?>
